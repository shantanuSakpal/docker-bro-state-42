...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const runningContainers: string[] = [
    "someid1", "someid2", "someid3", "someid4", "someid5"]
          ...
          <div>
            ...
            <li>
                <Link
                  ...
                  pathname.includes("dashboard")) || pathname && "bg-graydark dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/stats") &&
