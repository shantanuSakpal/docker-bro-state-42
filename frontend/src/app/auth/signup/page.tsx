...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | DockerWeb - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page DockerWeb Dashboard Template",
  // other metadata
};
